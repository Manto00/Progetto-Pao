...
#include "../../Filament3dPrint-master/view/view.h"
...
QT_MOC_LITERAL(1, 5, 10), // "viewClosed"
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (View::*_t)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&View::viewClosed)) {
                *result = 0;
                return;
            }
        }
