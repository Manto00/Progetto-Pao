...
private:
    ...
    /**
     * @brief createTitleLayout
     * Questo Metodo si occupa di realizare e predisporre il layout con il titolo e la descrizione della Home
     * @return Layout contenente il titolo e la descrizione della Home
     * private perch̬ invocato solamente nel costruttore
     */
    QLayout* createTitleLayout(const QString& description, const QString& imgPath);
    /**
    ...
    /**
     * @brief createExamLayout
     * Metodo che si occupa di realizzare e predisporre il layout di descrizione del grafico 1
     * @param description descrizione da inserire all'interno del layout
     * @return layout contenente la parte della descrizione del grafico 1
     * private perch̬ invocato solamente nel costruttore
     */
    QLayout* createExamLayout();
    /**
     * @brief createChartLayout
     * Metodo che si occupa di realizzare e predisporre il layout di descrizione del grafico 2
     * @param description descrizione da inserire all'interno del layout
     * @return layout contenente la parte della descrizione del grafico 2
     * private perch̬ invocato solamente nel costruttore
     */
    QLayout* createChartLayout();
    /**
